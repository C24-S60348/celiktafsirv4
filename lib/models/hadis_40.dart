...
/// Get content for the Hadis 40 Imam Nawawi page
Future<String?> _getHadis40Content(String url) async {
  final content =
...
/// Public access to get content for Hadis 40 page
Future<String?> getHadis40Content(String url) async {
  return _getHadis40Content(url);
}
      ...
      return FutureBuilder<String?>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final cleanedHtml =
                _removeNumbersFromUnorderedLists(snapshot.data!);
            ...
            return Html(
              ...
              style: {
                ...
                "em": createStyle(
                    color: htmlTextColor, fontStyle: FontStyle.italic),
                "i": createStyle(
                    color: htmlTextColor, fontStyle: FontStyle.italic),
                "u": createStyle(
                  color: htmlTextColor,
