...
class _BacaHujjahPageState extends State<BacaHujjahPage> {
  ...
  /// Copies the loaded article body. The fetch fills [_hujjahContent] on load,
  ...
  void _copyContent() {
    if (_hujjahContent == null || _hujjahContent!.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
    ...
    _copyTextToClipboard(htmlToPlainText(_hujjahContent!), type: 'Kandungan');
  }
